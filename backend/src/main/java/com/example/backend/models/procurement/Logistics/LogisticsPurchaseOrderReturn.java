...
@NoArgsConstructor
@AllArgsConstructor
@Table(name = "logistics_purchase_order_returns")
public class LogisticsPurchaseOrderReturn {
    ...
    @OneToMany(mappedBy = "logisticsPurchaseOrderReturn", cascade = CascadeType.ALL, orphanRemoval = true)
    @JsonManagedReference
    @Builder.Default
    private List<LogisticsPurchaseOrderReturnItem> items = new ArrayList<>();
