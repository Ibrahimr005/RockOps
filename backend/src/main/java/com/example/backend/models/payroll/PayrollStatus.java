...
public enum PayrollStatus {
    ...
    DEDUCTION_REVIEW(5, "Deduction Review", "Review and confirm all deductions including loans"),
    CONFIRMED_AND_LOCKED(6, "Confirmed and Locked", "Payroll calculations finalized and locked"),
    PENDING_FINANCE_REVIEW(7, "Pending Finance Review", "Awaiting finance team to review and approve payment"),
    PAID(8, "Paid", "Payroll processed and paid to employees");
    ...
    public PayrollStatus next() {
        switch (this) {
            ...
            case OVERTIME_REVIEW: return DEDUCTION_REVIEW;
