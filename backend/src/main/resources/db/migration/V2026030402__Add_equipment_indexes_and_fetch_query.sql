...
-- ================================================================
-- The equipment list endpoint does findAll + lazy-load 6 associations.
-- Adding indexes on FK columns speeds up JOIN FETCH queries and
-- any filtered queries (by site, type, status, etc.).
-- ================================================================
