...
const EquipmentDashboard = forwardRef(({ equipmentId }, ref) => {
    ...
    return (
        <div className="rockops-equipment-dashboard">
            ...
            <StatisticsCards
                cards={[
                    { icon: <Clock size={24} />, label: "Total Work Hours", value: stats.totalWorkHours, variant: "primary", subtitle: "Last 12 months" },
                    { icon: <Package size={24} />, label: "Consumables Used", value: stats.totalConsumables, variant: "success", subtitle: "Total quantity" },
                    { icon: <Wrench size={24} />, label: "Maintenance Events", value: stats.maintenanceEvents, variant: "warning", subtitle: "Last 12 months" },
                    { icon: <Activity size={24} />, label: "Average Hours/Month", value: stats.averageWorkHours, variant: "info", subtitle: "Monthly average" },
                ]}
                columns={4}
            />
